...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-blue-200 flex flex-col justify-center items-center p-4">
      <Paw className="w-24 h-24 text-blue-600 mb-8" />
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        <FeatureCard icon={<Paw className="w-12 h-12 text-blue-600" />} title="Adoption" description="Find your new best friend from our rescue center" />
        <FeatureCard icon={<Paw className="w-12 h-12 text-blue-600" />} title="Training" description="Expert dog training services for all breeds" />
        <FeatureCard icon={<Paw className="w-12 h-12 text-blue-600" />} title="Grooming" description="Professional grooming to keep your pup looking their best" />
      </div>
    </div>
  );
};
